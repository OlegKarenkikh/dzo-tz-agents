...
TENDER_PROPERTY_NO_CBR_LICENSE = """# Тендер: Страхование имущества административных зданий — ГБУ «ЦСО Центральный»
...
REAL_DOCS_REGISTRY = {
    ...
    # ── Insurance False-Positive: Tender without CBR license requirement ──
    "tender_property_no_cbr_license": {
        "agent": "tender",
        "text": TENDER_PROPERTY_NO_CBR_LICENSE,
        "filename": "tender_property_no_cbr_license.md",
        "subject": "Страхование имущества административных зданий — 44-ФЗ без лицензии ЦБ",
        "synthetic": True,
        "expected": {
            "expert_decision": "ВЕРНУТЬ НА ДОРАБОТКУ",
            "key_missing": ["Требование лицензии ЦБ РФ на страховую деятельность (Закон 4015-1)"],
            "insurance_type": "Имущество",
            "structural_score_pct": 70.0,
            "false_positive_type": "missing_cbr_license",
        },
        "source_url": None,
        "source_note": "Синтетический кейс: имущественный тендер 44-ФЗ без требования лицензии ЦБ РФ. "
                       "Rules-engine (без проверки CBR) → ПРИНЯТЬ. После CBR post-check → ВЕРНУТЬ НА ДОРАБОТКУ.",
    },
}
