...
> ⏱️ **20 минут** | 🟢 Новичок
> ⬅️ [Урок 1 — Виртуальное окружение](lesson_01_venv.md)
...
> 💡 **Аналогия:** Traceback — это как история звонков на телефоне. Последний звонок (самая нижняя строка) — это то, что случилось прямо сейчас. Именно с него нужно начинать читать.
...
## ⚠️ Типичные ошибки при чтении traceback

| Ошибка | Симптом | Правильный подход |
|---|---|---|
| Читать traceback сверху вниз | Зависаешь на импортах, теряешь корень | Читать **снизу вверх** — ошибка всегда внизу |
| Гуглить всё сообщение целиком | Много мусора, нет точного ответа | Гуглить только тип ошибки + ключевое слово |
| Игнорировать номер строки | Тратишь время на поиск места | Сразу переходить к строке из traceback |
| Не читать `caused by` / `__context__` | Пропускаешь первопричину | Всегда проматывать до самого первого исключения |
