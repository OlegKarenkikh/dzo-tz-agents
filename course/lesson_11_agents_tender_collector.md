...
| Понятие | Значение |
|---|---|
| agent21 (Тендер) | Анализирует тендерную документацию по 44-ФЗ и 223-ФЗ |
| agent3 (Collector) | Проверяет данные во внешних реестрах, не принимает решений |
| Прямые требования | Явно указаны в разделе «Состав заявки» |
| Косвенные требования | Вытекают из квалификационных условий |
