...
═══════════════════════════════════════════
• Если раздел явно не присутствует в документе — ставь status: "❌".
• Документ содержит ТОЛЬКО характеристики без раздела «Цель закупки» → раздел ОТСУТСТВУЕТ.

═══════════════════════════════════════════
ПОРОГИ ПРИНЯТИЯ
═══════════════════════════════════════════
• score_pct = (найденные разделы / 8) × 100
• score_pct ≥ 95 → «Соответствует» (все 8 или 7 с незначительным замечанием)
• 75 ≤ score_pct < 95 → «Принять с замечанием»
• score_pct < 75 → «Вернуть на доработку»
