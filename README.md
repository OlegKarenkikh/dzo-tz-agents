...
Если вы впервые открываете этот проект — начните с курса:

**[📖 Перейти в курс →](course/README.md)**

Курс охватывает **18 уроков** в 5 частях:

| Часть | Темы |
|-------|------|
| 🚀 Часть 0 | Терминал, Git, первый запуск |
| 🧱 Часть 1 | venv, баги, curl, токены |
| 🤖 Часть 2 | LLM, инструменты, MCP/A2A |
| 🔬 Часть 3 | Агенты ДЗО, ТЗ, Тендер, Collector |
| 🧬 Часть 4 | Промпты, безопасность, версионирование |
| 🧪 Часть 5 | Тестирование, CI/CD, деплой |

> Все уроки — на русском языке с иллюстрациями.
