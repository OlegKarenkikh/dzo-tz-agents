...
| Агент | Тестовых документов | Accuracy (rules-engine) | Accuracy (LLM) | Источники |
|-------|---------------------|------------------------|----------------|-----------|
| ДЗО   | 3                   | ~67%                   | TBD            | Синтетика (44-ФЗ/223-ФЗ шаблоны) |
| ТЗ    | 5                   | ~80%                   | TBD            | ЕЭК, rbank, АО Клевер |
| Тендер | 1                   | ~100%                  | TBD            | ПАО Россети (223-ФЗ) |
| Collector | —                | N/A                    | TBD            | — |

Методология и подробности: [docs/accuracy.md](docs/accuracy.md)
