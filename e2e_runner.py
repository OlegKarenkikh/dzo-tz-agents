...
print(json.dumps(process_file("dzo_example.txt", "dzo"), ensure_ascii=False, indent=2))
print(json.dumps(process_file("tz_example.txt", "tz"), ensure_ascii=False, indent=2))
